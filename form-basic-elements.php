...
<!-- Mirrored from demo.hasthemes.com/adomx-preview/dark/form-basic-elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Mar 2024 12:07:48 GMT -->
...
.contact-form {
    ...
    padding: 20px; /* Add padding to create space between form elements */
...
.contact-form select,
.contact-form button {
    background-color: transparent; /* Make input fields and button background transparent */
    border: 1px solid #ccc; /* Add border for input fields and button */
}

.contact-form input[type="text"],
.contact-form input[type="email"],
.contact-form select {
    width: 100%; /* Make input fields and select box full-width */
}
...
.contact-form .alert-notification {
    margin-top: 15px; /* Add space above alert message */
}
                ...
                <div class="col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                                ...
                                <div class="about-style-four" style="">
                                                    <div class="form1">
                                                        <div class="appinmentt-formss standard">
                                                            ...
                                                            <form method="POST" id="family" class="contact-form" enctype="multipart/form-data" style="background-color: #343434; border-radius: 2px;">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <div class="form-group">
                                                                            <label for="" style="color: white;">Old Price</label>
                                                                            <input class="form-control" id="Old" name="old" placeholder="Oldprice*" type="text" onkeyup="if(/\D/g.test(this.value)) this.value=this.value.replace(/\D/g,'')">
                                                                            <span class="alert-error"></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
